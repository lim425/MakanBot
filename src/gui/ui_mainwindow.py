...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.image_robotic_arm.setPixmap(QPixmap(u":/newPrefix/images/robotic arm idp.png"))
        ...
        icon = QIcon()
        icon.addFile(u":/newPrefix/images/minus_.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/newPrefix/images/plus.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"\u2022 \u201cFinish / Shutdown\u201d > Shutdown the system\n"
