...
class GUI():
    ...
    def guiPosition(self, offset1=20, offset2=50, offset3=150, offset4=30, offset5=30, offset6=50, offset7=150, offset8=280, offset9=30, offset10=40, offset11=20):
        ...
        self.button_feed = (self.home_button[0], self.home_button[3]+offset6, self.home_button[0]+offset8, self.home_button[3]+offset6+offset7)
        self.button_idle = (self.button_feed[2]+offset9, self.button_feed[1], self.button_feed[2]+offset9+offset8, self.button_feed[3])
        ...
        gui_position_boundaries = [self.gui_box, self.prompt_display, self.home_button , self.finish_button, self.voice_button, self.button_feed, self.button_idle, self.progress_bar]
    ...
    def guiDisplay(self, img):
        ...
        cv2.rectangle(img, (int(self.button_idle[0]), int(self.button_idle[1])), (int(self.button_idle[2]), int(self.button_idle[3])), (196, 186, 173), -1)
        ...
        self.drawTextCenter(img, "FEED", self.button_feed)
        self.drawTextCenter(img, "IDLE", self.button_idle)
