        ...
        while self._is_running:
            ...
            if ret:
                ...
                if faces:
                    ...
                    in_feed = gui_button_boundaries[5][0] < cursor_x < gui_button_boundaries[5][2] and gui_button_boundaries[5][1] < cursor_y < gui_button_boundaries[5][3]
                    in_idle = gui_button_boundaries[6][0] < cursor_x < gui_button_boundaries[6][2] and gui_button_boundaries[6][1] < cursor_y < gui_button_boundaries[6][3]

                    if in_home or in_finish or in_voice or in_feed or in_idle :
                ...
                if self.selected_box == "FEED":
                    self.gui.drawTextCenter(img, "Feeding Food", gui_button_boundaries[1], font_scale=2)
                elif self.selected_box == "IDLE":
                    self.gui.drawTextCenter(img, "Idle", gui_button_boundaries[1], font_scale=2)
